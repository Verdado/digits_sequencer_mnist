...
from digits_sequencer import digits_Sequencer
import numpy as np
from PIL import Image
import bcolz

class digits_Sequencer_API(object):

    def __init__(self):
        self.sequence_object = digits_Sequencer('data', 'images.byte', 'labels.byte')
    ...
    def generate_data(self, num_samples, seq_len, spacing_range=(0,0)):
        ...
        for i in range(num_samples):
            ...
            seq = self.generate_mnist_sequence(seq_values, spacing_range, 28 * seq_len)
            inputs.append(seq)
            labels.append(seq_values)
        print("image dataset of size " + str(num_samples) +" has been generated.")
    ...
    def save_image(self, img_data, sequence):
        ...
        print("Image " + img_name +" is generated and saved as " + img_name + ".png.")

    def save_array(self, data, fname):
        print("Save location " + str(fname) + ".")
